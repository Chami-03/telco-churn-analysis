...
Major Churn Drivers: Month-to-month contracts and Fiber Optic internet users show significantly higher churn rates.
...
Formatting: Standardized categorical values (e.g., converting binary "Yes/No" to descriptive labels).

Tenure Grouping: Created a conditional column to group customers into "Less than 1 Year" and "1 Year or More" for better trend analysis.
...
Contract Analysis: A breakdown of how contract types (Month-to-month vs. Yearly) impact retention.

Payment & Internet Trends: Analysis of churn rates based on payment methods (Electronic checks vs. Credit Cards) and service types (DSL vs. Fiber Optic).
...
Fiber Optic Quality Audit: Investigate why Fiber Optic users have higher churn rates—potential issues could include pricing or service stability.

Targeted Retention: Implement a proactive outreach program for customers in their first 6–12 months, as this is the highest risk period.

Project Contributor: Chamikara Wijerathne | Personal Project | January 2026
